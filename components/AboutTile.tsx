  ...
  return <div className="max-w-5xl  mx-auto my-8 ">
    <div className="bg-black text-white rounded-xl p-8 h-full w-full">
      <div className="max-w-3xl text-left">
        <h1 className="text-3xl text-orange-500 mb-5 font-bold">Ivatsiro-hotel</h1>
        <p className="py-2 text-sm text-slate-100 font-thin">L établissement <span className="text-[#21CE99] font-bold">Ivatsiro-hotel</span> vous offre une service impecable pour passer vos sejours dans le bonheurs.</p>
